...
<title>Rest client - Delete</title>
	...
	<section id="row">
		...
		<section id="main">
			<section id="content">
					...
					<label for="customerDelete">SSN</label><br> <input id="customerDelete" list = "customers" maxlength="10" autocomplete="off">
						<datalist id="customers">
							</datalist>
					
					<br> <input type="button" name="deleteBtn" value="Delete"
						id="deleteBtn">
			</section>
		</section>
	</section>
