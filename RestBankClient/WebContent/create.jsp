...
<title>Rest client - Create</title>
...
<body>
	...
	<section id="row">
		...
		<section id="main">
			<section id="content">
				<label for="ssn">SSN</label><br> <input type="text" name="ssn"
					id="ssn" value="" maxlength="10" autocomplete="off"><br>
				<label for="fullName">Full Name</label><br> <input type="text"
					name="fullName" id="fullName" value="" autocomplete="off"><br> <label
					for="address">Address</label><br> <input type="text"
					name="address" id="address" value="" autocomplete="off"><br> <label
					for="phoneNumber">Phone Number</label><br> <input type="text"
					name="phoneNumber" id="phoneNumber" value="" maxlength="10" autocomplete="off">
				<br> <input type="button" name="createBtn" value="Create"
					id="createBtn">
			</section>
		</section>
	</section>
