	...
	<section id="main">
		<nav id="menu">
			<form action="/BankClientProject/BankServlet" method="get">
				...
				<form action="/BankClientProject/BankServlet" method="get">
						<input type=image src="https://i.postimg.cc/3wS3C3hh/profile.jpg"
					alt="Submit feedback"> 
		...
		<section id="informationSection">
			...
			<form action="/BankClientProject/BankServlet" method="post"
				...
				<input type="text" name="SSN" id="SSN" value="<%=c.getSsn()%>"
					readonly> <br>
				...
				<input type="text" name="address" id="address"
					value="<%=c.getAddress()%>"> <br>
				<label for="phoneNumber">Phone Number</label><br>
				<input type="text" name="phoneNumber" id="phoneNumber" value="<%=c.getPhoneNumber()%>">
				 <br> 
				<input type="submit" name="settingsBtn" value="Save changes" id="updateBtn">
				<input type="submit" name="settingsBtn" value="Unregister" id="removeBtn"> 
				<input name="operation" value="settings" type="hidden">
			</form>
		</section>
				<%
				//Succed messege when update is successfull
				String profileTxt = (String)request.getAttribute("profileResponse");
				if(profileTxt != null){
					if(profileTxt.contains("success")){
						%>
						<p id="displayBoxSucced" class="displayBox" onload="setTimeout"> <%=profileTxt %>	</p>
					<%
					}
				}			
				%>
